...
<div class="container-lg">
	<div class="text-center text-head py-2">
		<h1 class="h1">International Collaboration - Institute-wise</h1>
	</div>
	<div class="text-body">
		<p class="text-justify">
			This page presents analytical data about International Collaboration in research output of Indian
			researchers. Top collaborating countries and institutions are identified. Analytical data is
			presented in table as well as figures. Overall collaborations for institutions as well
			as disciplinary variations in collaborations are presented.
		</p>
		<div class="container">
			<!-- slider -->
			<div class="row py-3">
